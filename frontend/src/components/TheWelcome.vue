...
<template>
  ...
  <div>
    ...
    <div class="db-info-w" v-if="sortedData">
      <div class="win-info-progs" v-for="item in sortedData">
        <div class="win-prog-info" v-if="!categoryParam || item.category == categoryParam">
          <img :src="item.url_image" width="128px" height="128px"><br>
          <div class="win-prog-text">
            Name: {{ item.name }}<br>
